 ...
 * ParamMailTbox
 *
 * @ORM\Table(name="param_mail_tbox")
 * @ORM\Entity(repositoryClass="MailBundle\Repository\ParamMailTboxRepository")
 */
class ParamMailTbox
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity="MailBundle\Entity\Mail", mappedBy="tbox")
     */
    private $mails;
