...
class RelationBusinessEntite
{
    ...
    * @ORM\JoinColumn(name="IDentite", referencedColumnName="IDEntite", nullable=true)
    */
    private $entite;
    ...
    */
     ...
     * Set businessunit
     *
     * @param \UsersBundle\Entity\BusinessUnit $businessunit
     *
     * @return RelationBusinessEntite
     */
    public function setBusinessunit(\UsersBundle\Entity\BusinessUnit $businessunit = null)
    {
     ...
     * Get businessunit
     *
     * @return \UsersBundle\Entity\BusinessUnit
     */
