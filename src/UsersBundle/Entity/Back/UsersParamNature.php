 ...
 * UsersParamNature
 *
 * @ORM\Table(name="param_user_nature")
 * @ORM\Entity(repositoryClass="UsersBundle\Repository\Back\UsersParamNatureRepository")
 * @ProjectBundle\Annotation\Label\LabelClass
 */
class UsersParamNature
{
    /**
     * @var int
     *
