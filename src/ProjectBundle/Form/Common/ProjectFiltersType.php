...
class ProjectFiltersType extends AbstractType
{   
    // setting date
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        // roles
        $users_roles = Utils::Array_extract($options['dataForm']['users_roles'], ['key'=>'getLabel','value'=>'getId']);
        // roles
        ...
        $title = Utils::Array_extract($options['dataForm']['projectFilters'], ['key' => 'getLabel','value' => 'getId']);
        //====================================
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'ProjectBundle\Entity\Common\ProjectsFilters',
            'dataForm' => null,
        ))
