 ...
 * Jalon
 *
 * @ORM\Table(name="param_crm_resultats")
 * @ORM\Entity(repositoryClass="CrmBundle\Repository\Back\CrmParamResultatRepository")
 * @ProjectBundle\Annotation\Label\LabelClass
 */
class CrmParamResultat
{
    /**
     * @var int
     *
     ...
     * @var int
     *
     * @ORM\Column(name="idTyperesultat", type="integer", length=11)
     */
     ...
     * Set idTyperesultat
     *
     * @param integer $idTyperesultat
     *
     * @return Resultat
     */
    public function setIdTyperesultat($idTyperesultat)
    {
     ...
     * @return int
     */
    public function getIdTyperesultat()
    {
